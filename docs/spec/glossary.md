...
| 固有属性               | `InnateAttribute`              | —                  | A boss soul's innate attribute; one of six `SoulAttribute`s, held apart from its sub-attributes. A soul's is `Soul::innate`. The import preview labels it 固定属性                                           |
