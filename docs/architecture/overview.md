...
| `yata-protocol` | pure      | the frame codec; Rust types generated from the core and snapshot schemas; the yata-snapshot file                                                                           | 3 — its reader-side consumer is gone (ADR-0030) |
