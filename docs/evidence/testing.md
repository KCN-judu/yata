...
| each decided group rules a soul out, and wins over every open rule                                                         | `evaluate::tests::each_decided_group_rules_a_soul_out`, `a_decided_failure_wins_over_every_open_rule`, `a_level_above_fifteen_is_in_no_band`                                                                                                                     |
| open rules are named, never guessed                                                                                        | `empty_groups_are_open_and_named`, `includes_are_decided_only_where_and_and_or_agree`, `with_a_count_chosen_includes_are_not_decided`, `an_innate_choice_is_open_while_a_soul_has_no_innate_attribute`, `any_set_picks_every_soul_and_is_not_an_empty_group`     |
