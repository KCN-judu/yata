...
| a broken frame ends the session with `session_failed`                                      | `a_broken_frame_ends_the_session_with_an_event`, `a_payload_that_is_not_a_message_ends_the_session`  |
...
| a chosen 固有属性 is open, and named, only for a boss soul whose own set is not chosen (`AnySet`, or no set)                                                                                         | `a_boss_soul_whose_set_is_not_chosen_is_open_unless_its_innate_attribute_is`                                                                                                                                                                                                             |
...
| malformed protocol trees are refused with their code; past the decoder's recursion limit too                    | `malformed_trees_are_refused_with_their_code`, `a_tree_past_the_decoders_recursion_limit_is_malformed_not_a_crash`, `bytes_that_are_not_a_request_are_malformed`, `request_level_refusals_carry_their_codes`, `a_soul_must_state_its_kind` |
