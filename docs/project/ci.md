...
| ---------- | -------------- | ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `docs`     | Linux          | `docs-ci`     | records are well-formed; Markdown is formatted and lint-clean; scripts are typed and lint-clean; nothing local-only or key-like is tracked; SQL stays in `yata-store`; icons follow the SVG profile; the release rules; every error code the app can meet has text                               |
...
| `flutter`  | Linux          | `flutter-ci`  | the committed Dart bindings match `protoc` 36.2 with `protoc_plugin` 25.1.0; Dart formatting, the analyzer, the Flutter tests                                                                                                                                                                    |
