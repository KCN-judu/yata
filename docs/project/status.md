...
| scheme code / SoulSelection (ADR-0009)    | partial     | layout codec (header, account, records); solved-bit edits; from-scratch sets; the constant header segment; `scheme plans/retarget/build` | SoulSelection, the bit ↔ soul/attribute mapping in code, `matches`, the per-profile account fact  | [evidence/testing.md](../evidence/testing.md)                        |
