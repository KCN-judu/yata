...
| scheme code / SoulSelection (ADR-0009)    | accepted    | ADR-0009, spec/scheme-code.md; framing confirmed by an import                                                                   | the layout codec, SoulSelection, the bitmask mapping, `matches`, template editing, the per-profile header | —                                                                    |
