...
| ----------------------------------------- | ----------- | --------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- | -------------------------------------------------- |
| crates (ADR-0001, ADR-0005)               | implemented | `yata-core`, `yata-store` (pure, effect lints); `yata-daemon`; `crate-graph` check                  | `yata-protocol`                                                                                   | `crates/*/clippy.toml`, `scripts/preflight.py`     |
