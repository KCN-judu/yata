...
Only the repository tooling is implemented. Everything else reads _designed_ or
_accepted_.
...
| ------------------------------------------------- | ----------- | -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- | -------------------------------------------------- |
| pure core (ADR-0001), crate boundaries (ADR-0005) | accepted    | ADRs, architecture/overview.md crate table                                                         | workspace, crates, any code                                                                       | —                                                  |
...
| domain vocabulary                                 | designed    | glossary.md                                                                                        | yata-core crate, any type                                                                         | —                                                  |
