...
| scheme code / SoulSelection (ADR-0009)    | accepted    | ADR-0009, spec/scheme-code.md                                                                                                   | SoulSelection, the bitmask mapping, `matches`, template editing (blocked on the payload's framing) | —                                                                    |
