...
| #   | Item                                                                                                                                                                                     | Gated on                                                                                    |
| --- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- |
| 1   | Rust workspace: `yata-core` with the soul model and `soul-mechanics.md`; `yata-store` (ADR-0019); `yata-protocol` with the frame codec; `yata-daemon` as its first code lands (ADR-0005) | nothing                                                                                     |
| 2   | Probe schema: the typed soul record and `ProbeExport` (ADR-0008), drafted from the documented hypotheses, then checked or corrected against the reader's first recordings                | nothing to draft; confirmation on 3 (ADR-0014)                                              |
