...
AREAS = {"domain", "import", "scoring", "persistence", "ui", "tooling", "process"}
...
# Valid ids whose records are kept in local research, not in docs/ (ADR-0016, rule 5).
LOCAL_IDS = {"PRP-0001", "PRP-0002"}
